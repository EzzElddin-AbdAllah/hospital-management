...
// const DoctorProfile = () => {
// 	return (
// 		<Group className="items-start my-10 md:p-14 flex-nowrap lg:items-center lg:my-0">
...
// 				<Text
// 					dir="rtl"
// 					className="pl-5 text-xl text-justify text-black lg:text-3xl text-opacity-60"
// 				>
