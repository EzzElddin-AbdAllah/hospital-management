...
const DashboardAuth = () => {
	...
	return (
		<Stack dir="rtl" className="bg-[#f6f7fa] h-screen">
			...
			<Group className="xl:mx-40 lg:mx-10 xl:mt-20 lg:mt-10 lg:flex-nowrap">
				<div>
					<svg
						width="378"
						height="312"
				...
				>
					...
					<Button
						type="submit"
						radius="xl"
						className="bg-[#1B77CB] hover:bg-blue-600 text-white px-10 h-10"
					>
						دخول
					</Button>
				</form>
