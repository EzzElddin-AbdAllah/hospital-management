...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      focus:ring-neutral-950 focus:ring-offset-2 disabled:cursor-not-allowed
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        border-neutral-200 bg-white text-neutral-950 shadow-md
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      pl-8 pr-2 text-sm outline-none focus:bg-neutral-100 focus:text-neutral-900
