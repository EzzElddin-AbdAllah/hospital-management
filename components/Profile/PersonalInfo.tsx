  ...
  return (
    <>
      <Stack dir="rtl">
        ...
        <Button
          onClick={open}
          className="w-fit rounded-full bg-[#1D52AF] px-8 text-white hover:bg-blue-800 lg:rounded-lg"
        >
          تعديل
        </Button>
      </Stack>
      ...
      <Modal opened={opened} onClose={close} centered dir="rtl">
        <form onSubmit={handleSubmit(onSubmit)}>
          <Stack>
            ...
            <Button
              type="submit"
              className="mt-4 w-full rounded-full bg-[#1D52AF] text-white hover:bg-blue-800 lg:rounded-lg"
            >
              حفظ
            </Button>
          </Stack>
